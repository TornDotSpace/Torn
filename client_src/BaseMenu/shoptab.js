...
global.rBuyShipWindow = function() {
  ...
  if (shipView <= rank) {
    ...
    baseMenuCtx.fillRect(shipStatsRx+60, shipStatsRy + 2 * 16 - 10, 80, 12); if (shipView!=17)
    {baseMenuCtx.fillRect(shipStatsRx+60, shipStatsRy + 3 * 16 - 10, 80, 12);} // 17 has infinite cargo
    baseMenuCtx.fillStyle = "white";
    ...
    baseMenuCtx.fillRect(shipStatsRx+60, shipStatsRy + 2 * 16 - 10, 80*ships[shipView].health /maxShipHealth, 12); if (shipView!=17)
  ...
  baseMenuCtx.fillStyle = "white";
  if (shipView<=rank)
  {wrapText(baseMenuCtx, translate("Description: ") + ships[shipView].desc, 512 - 64, 256 + 10 * 16 + 5, 64 * 6 - 64, 16);}
...
global.rConfirm = function() {
  ...
  write(baseMenuCtx, translate("Are you sure you would like to sell your # for $#?", [wepns[equipped[confirmer]].name, wepns[equipped[confirmer]].price * .75]), 128 * 3, 128);
