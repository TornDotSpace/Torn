...
function rOreShop(){
	...
	write((iron > 0 ? mEng[133] : mEng[137]) + iron + " => $" + allIronPrice + " ($"+mult1+" " + mEng[155] + ")", rx + 256 - 32, ry + 3 * 32);
	ctx.fillStyle = (6 == seller) ? 'lime' : '#eef';
	write((silver > 0 ? mEng[134] : mEng[138]) + silver + " => $" + allSilverPrice + " ($"+mult1+" " + mEng[155] + ")", rx + 256 - 32, ry + 4 * 32);
	ctx.fillStyle = (7 == seller) ? 'lime' : '#90f';
	write((platinum > 0 ? mEng[135] : mEng[139]) + platinum + " => $" + allPlatinumPrice + " ($"+mult1+" " + mEng[155] + ")", rx + 256 - 32, ry + 5 * 32);
	ctx.fillStyle = (8 == seller) ? 'lime' : '#960';
	write((copper > 0 ? mEng[136] : mEng[140]) + copper + " => $" + allCopperPrice + " ($"+mult1+" " + mEng[155] + ")", rx + 256 - 32, ry + 6 * 32);

	ctx.fillStyle = seller == 610 ? 'lime' : 'yellow';
	write(mEng[12] + " => $" + (allCopperPrice + allPlatinumPrice + allSilverPrice + allIronPrice), rx + 256 + 48, ry + 76); // Sell all
